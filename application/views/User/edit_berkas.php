					...
					<div class="panel panel-default">
						...
						<table id="user" class="display table table-bordered table-hover table-responsive">
							<div id=”container”>
								...
								echo form_open('hal_user/simpan_edit_berkas', $att);
								...
								<table id="berkas" class="display table table-bordered table-hover table-responsive">
									<div id=”container”> 
										...
										<tr>
											<td>Nama Berkas</td>
											<td><input class="form-control" type="text" name="nama_berkas" value="<?php echo $edit->nama_berkas; ?>"/></td>
										</tr>
										<tr>
											<td>Keterangan</td>
											<td><input class="form-control" type="text" name="keterangan" value="<?php echo $edit->keterangan; ?>"/></td>
										</tr>
										<tr>
											<td>Tanggal</td>
											<td><input class="form-control" type="date" name="tanggal" value="<?php echo $edit->tanggal; ?>"/></td>
										</tr>
										<tr>
											<td>Jenis</td>
											<td>
                      ...
                      <option value="Gambar">File Gambar</option>
										...
										<tr>
											<td>Berkas</td>
											<td><input class="form-control" type="file" name="berkas" value="<?php echo $edit->berkas; ?>"/></td>
										</tr>
										<td></td>
