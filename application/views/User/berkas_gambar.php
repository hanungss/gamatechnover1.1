			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							Berikut adalah Berkas dengan jenis gambar
						</div>



						<div class="table-responsive">
							<table id="cek_berkas" class="display table table-bordered table-hover table-responsive">
								<div id=”container”>
									<tr>
										<th>No</th>
										<th>Nama Berkas</th>
									...
									<?php 
									if(!empty($berkas_gambar))
									foreach ($berkas_gambar as $row){ ?>
									<tr>
										<td></td>
